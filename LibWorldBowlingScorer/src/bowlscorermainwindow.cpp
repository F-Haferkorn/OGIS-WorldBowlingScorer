...
void BowlScorerMainWindow::respawnBowlScorer(int countOfPlayers) {
...
QToolBar *BowlScorerMainWindow::initToolBar() {
  m_toolBar = new QToolBar(this);
  m_toolBar->addAction("reset", this, &BowlScorerMainWindow::resetGame)
      ->setToolTip("reset the game");
  m_toolBar->addSeparator();
  m_toolBar->addAction("restart", this, &BowlScorerMainWindow::restartGame)
      ->setToolTip("restart the game");
  m_toolBar->addAction("player++", this, &BowlScorerMainWindow::addPlayer)
      ->setToolTip("add a player");
  m_addPlayerAction = m_toolBar->actions().last();

  m_toolBar->addSeparator();
  m_toolBar->addAction("Fault", this, &BowlScorerMainWindow::throwFault)
      ->setToolTip("throw FAULT");
  m_toolBar->addAction("0", this, &BowlScorerMainWindow::throw0)
      ->setToolTip("throw NO pin");
  m_toolBar->addAction("1", this, &BowlScorerMainWindow::throw1)
      ->setToolTip("throw 1 pin");
  m_toolBar->addAction("2", this, &BowlScorerMainWindow::throw2)
      ->setToolTip("throw 2 pins");
  m_toolBar->addAction("3", this, &BowlScorerMainWindow::throw3)
      ->setToolTip("throw 4 pins");
  m_toolBar->addAction("4", this, &BowlScorerMainWindow::throw4)
      ->setToolTip("throw 4 pins");
  m_toolBar->addAction("5", this, &BowlScorerMainWindow::throw5)
      ->setToolTip("throw 5 pins");
  m_toolBar->addAction("6", this, &BowlScorerMainWindow::throw6)
      ->setToolTip("throw 6 pins");
  m_toolBar->addAction("7", this, &BowlScorerMainWindow::throw7)
      ->setToolTip("throw 7 pins");
  m_toolBar->addAction("8", this, &BowlScorerMainWindow::throw8)
      ->setToolTip("throw 8 pins");
  m_toolBar->addAction("9", this, &BowlScorerMainWindow::throw9)
      ->setToolTip("throw 9 pins");
  m_toolBar->addAction("10", this, &BowlScorerMainWindow::throw10)
      ->setToolTip("throw 10 pins (a STRIKE)");
...
void BowlScorerMainWindow::enableToolBar(int allowedCountOfPins) {
  ...
  for (int index = 0; index < actions.size() - startIndex;
       index++) // values 0..10 of add-action
  {
...
void BowlScorerMainWindow::resetGame() {
  respawnBowlScorer(c_initialPlayersCount);
  enableToolBar(10);
...
void BowlScorerMainWindow::gameEnds() {
  enableToolBar(-1);
  m_bowlScorer->markWinners();
  m_addPlayerAction->setVisible(false);
}

void BowlScorerMainWindow::addPlayer() {

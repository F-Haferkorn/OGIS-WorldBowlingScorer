...
public:
    ...
    int  totalScore() {
        /// do NOT forward own score frame's scoreis not be rendered.
        /// and wil not apper on totalScoreand on resultScore of BowlPlayerScore
        return m_previousScore
                + (shouldScoreBeRendered() ? score() : 0) ;
    }
